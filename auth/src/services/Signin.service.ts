...
export class SigninService {
   ...
   * @returns {Promise<{ user: User, userJwt: string }>} A Promise that resolves to an object containing the authenticated user and their corresponding JWT (JSON Web Token).
   ...
   */
  public async signin(email: string, password: string): Promise<{ user: User, userJwt: string }> {
    try {
