...
import { ParticipantsAddedListener } from './events/listeners/participant-added-listener';
import { ParticipantRemovedListener } from './events/listeners/participant-removed-listener';
...
class Server {
  ...
  public async up(): Promise<void> {
    try {
      ...
      new ParticipantRemovedListener(natsWrapper.client).listen();
